...
public class EmailSendService {
    ...
    public void sendEmail() throws MessagingException {
        ...
        String userName = "혜린";
        String content = userName + "님을 위한 럭키 데이가 드디어 내일이에요.<br>" +
                "나에게 어떤 럭키한 하루가 기다리고 있을지, 기대되지 않나요?<br>" +
                "내일 잊지 말고 아래 버튼을 클릭해서 특별한 럭키 데이 활동을 확인해 보세요.<br><br>" +
                "<div style='text-align: center;'>" +
                "[럭키 데이 확인하러 가기 \uD83C\uDF40]" +
                "</div><br>" +
                "특별한 활동을 가이드 삼아, 우연과 행복이 함께하는 럭키 데이 보내시기를 바라요!☺️ <br>" +
