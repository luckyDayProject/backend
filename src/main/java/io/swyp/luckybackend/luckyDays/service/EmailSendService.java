...
import io.swyp.luckybackend.luckyDays.repository.LcAlarmRepository;
...
public class EmailSendService {
    ...
    @Autowired
    private LcAlarmRepository lcAlarmRepository;
    ...
    public void sendEmail(List<SendMailDto> mailDtos) throws MessagingException {
        ...
        for (SendMailDto mailDto : mailDtos) {
            try {
                ...
                mailHelper.setFrom("LuckyDay <enjoyluckday@gmail.com>");
